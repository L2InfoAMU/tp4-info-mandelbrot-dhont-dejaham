...
public class ComplexTest {
    ...
    void testMultiply(){
        ...
        assertEquals(new Complex(2,-2), two.multiply(oneMinusI));
        assertEquals(new Complex(-1,-1), onePlusI.multiply(minusOne));
    }
    ...
    @Test
    void testEquals(){
        assertTrue(onePlusI.equals(onePlusI));
        assertTrue(oneMinusI.equals(new Complex(1,-1)));
        assertFalse(minusI.equals(-2));
        assertFalse(two.equals(onePlusI));
    }
}